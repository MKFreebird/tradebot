...
class Bl3pApi:
	...
	def addOrder(self, market, order_type, order_amount, order_price):
		...
		return self.apiCall('%s/money/order/add' % market, params)
	...
	def orderInfo(self, market, order_id):
		...
		return self.apiCall("%s/money/order/result" % market, params)
	...
	# Get ticker
	# @return array   json structure with market data
	def getTicker(self):
		params = { }
		return self.apiCall('BTCEUR/ticker', params)
